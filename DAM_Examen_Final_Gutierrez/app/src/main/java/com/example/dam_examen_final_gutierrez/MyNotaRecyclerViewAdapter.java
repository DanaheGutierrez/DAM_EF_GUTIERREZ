...
import com.example.dam_examen_final_gutierrez.databinding.FragmentItemBinding;
...
public class MyNotaRecyclerViewAdapter extends RecyclerView.Adapter<MyNotaRecyclerViewAdapter.ViewHolder> {
    ...
    public MyNotaRecyclerViewAdapter(List<Nota> mValues, NotasInteractionListener mListener) {
